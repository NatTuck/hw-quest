---
title: "cs4140 Notes: 09-09 Agile Software Dev"
date: "2026-09-07"
---
...
- We have 7 students.
- That's not quite enough for multiple teams (we really want at least 5 per team
  so we start to benefit from process), so we'll do *one* team.
- That means that you all are one team, developing a Multiplayer Browser Game
- I'm going to ramble for a bit. Think about game ideas so we can discuss some
  towards the end of class

## Topics We'll See This Semester
...
Our plan is to be vaguely agile.
 ...
 - We're going to aggressively use the tools provided by Github,
   including a Kanban board if we can get it to work.
 - We're building a game, and the design and development team are
   the same, so that reduces friction compared to typical corporate
   custom dev.
 - We're going to try to do continuous integration and deployment so
   we always have a working (and deployed) program.

## Overflow: Planning Meeting

- Coordinated: Game ideas.
