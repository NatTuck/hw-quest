...
## Practice Final Exam: cs2381 Fall 2025

2025-12-02: This sample exam is provided to help provide some
...
The answer to an "asymptotic complexity" question on this practice exam will be
one of: O(1), O(log n), O(n), O(n log n), O(n^2), O(n^2 log n), O(n^3), O(2^n)
