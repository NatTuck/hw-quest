---
title: "Lecture Notes: 02-06 Values and References"
date: "2026-02-04"
---

In C, we have a bunch of integer types and two ways to combine them into larger
data structures:

- Arrays (a sequence of the same type, fixed length at allocation but
  unknown length on use).
