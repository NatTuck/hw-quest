---
title: "Lecture Notes: 04-20 Modern FS"
date: "2026-04-18"
---
...
- If you don't want to worry about filesystems and have backups,
  ext4 on Linux is fine (or xfs if you want to be fancy).
- If you care about your data on Linux, have backups and run
  a 2+ disk BTRFS pool with "raid1".

## Send / Recv

BTRFS has a neat feature: brtfs-send / btrfs-recv

This allows a read-only snapshot to be efficiently synced with
another filesystem.

Two modes:

- Send a full snapshot.
- Send a snapshot as a diff from a parent snapshot.
